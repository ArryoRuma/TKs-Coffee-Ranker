...
export const users: AppUser[] = [
  {
    ...
    handle: "@tkruma",
    name: "TK Ruma",
    bio: "Documenting the long path from flat whites to nuanced pour-overs.",
    homeCity: "Jakarta",
  ...
  },
  {
    ...
    handle: "@aria.beans",
    name: "Aria Putri",
    bio: "Weekend cafe hunter, daily espresso realist.",
    homeCity: "Bandung",
...
export const coffeeEntries: CoffeeEntry[] = [
  {
    ...
    rating: 9,
    reviewBody:
      "Balanced sweetness and bright citrus. Oat texture stayed creamy without muting acidity.",
  ...
  },
  {
    ...
    rating: 8,
    reviewBody:
      "Clean cup with a juicy finish. A tiny bit under-extracted, but still very aromatic.",
